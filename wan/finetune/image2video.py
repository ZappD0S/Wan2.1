...
class WanI2V:
    ...
    def _build_context(self, img, prompt, n_prompt, offload_model):
        if n_prompt == "":
    ...
    def _compute_noise_pred(
        ...
        [noise_pred_cond] = self.model(latent, **cond_kwargs)
    ...
    def generate(
        ...
        noise, y, max_seq_len = self._build_latents(img, frame_num, max_area, seed_g)
        ...
        with (
            ...
            for i, t in enumerate(tqdm(timesteps)):
                ...
                # here we will use sample_scheduler.add_noise(
